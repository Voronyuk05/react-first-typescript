...
export const QuestionsContent: React.FC<IContentProps> = ({setModal}): JSX.Element => {
    return (
        <QuestionsContentComponent>
            ...
            <ContentText>
                ...
                <ContactButton onClick={() => setModal(true)}>Позвоните, у меня остались вопросы</ContactButton>
